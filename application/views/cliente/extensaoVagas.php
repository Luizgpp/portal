<div class="corpo">
	...
	<div class="row">
		...
		<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 empresas">
			<h1>Vagas Desativadas</h1>
		</div>
		<div class="row">
			<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-lg-offset-2">

				<?php 
				if(!empty($vagasDesativadas)) :
					foreach ($vagasDesativadas as $vaga) : ?>
				<!-- ################ Vagas ################## -->
				...
				<div class="vagas">
					...
					<div class="btn-group-vertical empresaBotao" role="group" aria-label="...">
						...
						<div class="btn-group btn-group-justified" role="group" aria-label="...">
							<div class="btn-group" role="group">
								<button type="button" class="btn btn-default" onClick="window.location='<?php echo site_url('extvagas/ativarVaga/'.$vaga->id)?>'"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button>
							</div>
						</div>
					</div>
				</div>
